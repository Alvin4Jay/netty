...
public interface SelectStrategy {
    ...
    /**
     * Indicates a blocking select should follow. SELECT表示进行阻塞式select
     */
    int SELECT = -1;
    /**
     * Indicates the IO loop should be retried, no blocking select to follow directly. CONTINUE表示重试IO循环
     */
    int CONTINUE = -2;
